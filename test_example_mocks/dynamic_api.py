...
async def post__login():
    ...
    return {"token":"jwt_token_1_1775046910.836846","user":{"id":1,"username":"testuser","email":"testuser@example.com"}}
...
async def post__checkout(request: Request):
    ...
    if body.get("coupon_code") == "EXPIRED2026":
        ...
        return {"order_id":"ORD-20260401203510-2764","status":"confirmed","items":[{"product_id":"iphone15","name":"iPhone 15 Pro","price":999.99,"quantity":1},{"product_id":"airpods","name":"AirPods Pro","price":249.99,"quantity":2}],"subtotal":1499.97,"discount":149.997,"total":1349.973,"estimated_delivery":"2026-04-05","tracking_url":"https://tracking.example.com/ORD-20260401203510-2764"}
    else:
        return {"order_id":"ORD-20260401203510-2764","status":"confirmed","items":[{"product_id":"iphone15","name":"iPhone 15 Pro","price":999.99,"quantity":1},{"product_id":"airpods","name":"AirPods Pro","price":249.99,"quantity":2}],"subtotal":1499.97,"discount":149.997,"total":1349.973,"estimated_delivery":"2026-04-05","tracking_url":"https://tracking.example.com/ORD-20260401203510-2764"}
